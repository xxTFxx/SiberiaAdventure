	...
	public static final WorldGenStructure MINE1 = new WorldGenStructure("mine1");
		...
		public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
		{
			...
			case 0:
				...
				generateStructure(SHOUSE, SHOUSE.getName() ,world, random, chunkX, chunkZ, 100, Blocks.GRASS, BiomeSiberia.class , BiomeForest.class , BiomePlains.class , BiomeTaiga.class);
				generateStructure(MINE1, MINE1.getName() ,world, random, chunkX, chunkZ, 70, Blocks.GRASS, BiomeSiberia.class);
